...
export default function (){
    ...
    <div className={styles.contenedor}>
        <div className={styles.contenedor}>
            <button className={styles.buttonAtras} onClick={handleNavigate}>Atrás</button>
            <h2 className={styles.title}>Registrate</h2>
            <form className={styles.contForm} onSubmit={submit}>
                <div className={styles.contForm}>
                    <div className={styles.form}>
                        <label htmlFor="Usuario">Usuario</label>
                        <input type="text" name="name" className={styles.input} value={form.name} onChange={handleChange}/>
